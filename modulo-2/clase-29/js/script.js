...
// Funciones flechas con parámetros implícito

// const cuadrado = x => x * x

// Ejemplo N°1
// const area_rectangulo = (a, b) => {
//     return a * b
// }

// console.log(area_rectangulo(3, 6));
...
// Ejemplo N°3
// Función para filtrar números negativos de una lista
// const numeros = [-150, 5959, -58, 96]
// const negativos = numeros.filter(numero => numero < 0)
// console.log(negativos);

// Ejercicio N°4
// Dado un arreglo de nombres, mapear la lista completa y pasar todos los datos a mayúsculas e imprimirlos en consola
